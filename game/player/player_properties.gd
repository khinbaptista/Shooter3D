...
export(float, 0.5, 500.0, 0.5) var jump_min_height = 30.0
export(float, 0.5, 500.0, 0.5) var jump_max_height = 100.0
export(float, 0.05, 5.0, 0.05) var jump_max_ms = 1000.0
